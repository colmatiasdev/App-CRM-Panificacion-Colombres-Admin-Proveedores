...
(function () {
  ...
  var columnas = [
    ...
    { nombre: "Tiempo-Produccion-Minutos", alias: "Tiempo (min)", tipoDato: "numeric", tipoComponente: "label", visible: true, descripcion: "Tiempo de producción." },
    ...
    { nombre: "Costo-Produccion[C+E]", alias: "Costo Producción [C+E]", tipoDato: "numeric", tipoComponente: "label", decimales: 2, visible: true, descripcion: "Fórmula C+E.", formatoVisual: "moneda" },
    ...
    { nombre: "Rendimiento-UnidadMedida", alias: "Rendimiento U.M.", tipoDato: "text", tipoComponente: "label", visible: true, descripcion: "Unidad de medida." },
    { nombre: "Costo-Produccion-ProductoBase [F/G]", alias: "Costo Base [F/G]", tipoDato: "numeric", tipoComponente: "label", decimales: 2, visible: true, descripcion: "Fórmula F/G.", formatoVisual: "moneda" }
  ];
