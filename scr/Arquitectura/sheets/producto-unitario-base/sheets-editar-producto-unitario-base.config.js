...
(function () {
  ...
  var hoja = base.hoja;
  var columnas = [
    { nombre: "Orden", alias: "Orden", tipoDato: "numeric", tipoComponente: "text-box", visible: true, obligatorio: true, restricciones: { min: 0, entero: true } },
    ...
    { nombre: "Costo-Elaboracion-Anterior", alias: "Costo Anterior", tipoDato: "numeric", tipoComponente: "label", decimales: 2, visible: true, obligatorio: false, formatoVisual: "moneda" },
    ...
    { nombre: "Fecha-Registro-Actualizado-Al", alias: "Actualizado", tipoDato: "text", tipoComponente: "label", visible: false, obligatorio: false }
  ];
