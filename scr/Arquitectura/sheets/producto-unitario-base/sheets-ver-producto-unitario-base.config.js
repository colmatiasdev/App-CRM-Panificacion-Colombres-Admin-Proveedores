...
(function () {
  ...
  var hoja = base.hoja;
  var columnas = [
    { nombre: "Orden", alias: "Orden", tipoDato: "numeric", tipoComponente: "label", visible: true },
    { nombre: "IDCosto-ProductoUnitario", alias: "ID Costo Producto Unitario", tipoDato: "text", tipoComponente: "label", visible: true },
    { nombre: "Comercio-Sucursal", alias: "Comercio Sucursal", tipoDato: "text", tipoComponente: "label", visible: true },
    { nombre: "Tipo-Producto", alias: "Tipo Producto", tipoDato: "text", tipoComponente: "label", visible: true },
    { nombre: "Nombre-Producto", alias: "Nombre Producto", tipoDato: "text", tipoComponente: "label", visible: true },
    { nombre: "IDElaboracion-ProductoBase", alias: "ID Elaboración Base", tipoDato: "text", tipoComponente: "label", visible: true },
    ...
    { nombre: "Habilitado", alias: "Habilitado", tipoDato: "text", tipoComponente: "label", visible: true },
    { nombre: "Fecha-Registro-Actualizado-Al", alias: "Actualizado", tipoDato: "text", tipoComponente: "label", visible: true }
  ];
