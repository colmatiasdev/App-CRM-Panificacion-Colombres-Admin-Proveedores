...
(function () {
  ...
  var hoja = base.hoja;
  var columnas = [
    { nombre: "Orden", alias: "Orden", tipo: "numeric", nullable: true, label: true, visible: false, restricciones: { min: 0, entero: true } },
    ...
    { nombre: "Costo-Producto-Maestro-Total", alias: "Costo Producto Maestro Total", tipo: "numeric", nullable: true, decimales: 2, visible: false, restricciones: { min: 0 } },
    { nombre: "Costo-Packing", alias: "Costo Packing", tipo: "numeric", nullable: true, decimales: 2, visible: false, restricciones: { min: 0 } },
    { nombre: "Costos-Fijos", alias: "Costos Fijos", tipo: "numeric", nullable: true, decimales: 2, visible: false, restricciones: {} },
    { nombre: "Merma-Porcentaje", alias: "Merma Porcentaje", tipo: "numeric", nullable: true, decimales: 2, visible: false, restricciones: { min: 0, max: 100 } },
    { nombre: "Merma-Importe", alias: "Merma Importe", tipo: "numeric", nullable: true, decimales: 2, visible: false, restricciones: { min: 0 } },
    { nombre: "Tiiempo-Packing-Minutos", alias: "Tiempo Packing Minutos", tipo: "numeric", nullable: true, visible: false, restricciones: { min: 0, entero: true } },
    { nombre: "Costo-Mano-Obra-Packing", alias: "Costo Mano Obra Packing", tipo: "numeric", nullable: true, decimales: 2, visible: false, restricciones: { min: 0 } },
    ...
    { nombre: "Costo-Producto-Final-Anterior", alias: "Costo Producto Final Anterior", tipo: "numeric", nullable: true, decimales: 2, visible: false, restricciones: { min: 0 } },
