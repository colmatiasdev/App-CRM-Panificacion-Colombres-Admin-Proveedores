/**
 * Configuración de la acción Ver para Receta Detalle (Tabla-Receta-Base-Detalle).
 */
(function () {
  var base = window.RECETA_DETALLE_SHEET_BASE;
  if (!base || !base.hoja) throw new Error("Cargá receta-detalle-sheets-base.js antes de sheets-ver-receta-detalle.config.js");
  var hoja = base.hoja;
  var columnas = [
    {
