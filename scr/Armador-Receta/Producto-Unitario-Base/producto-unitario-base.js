/**
 * Listado de Producto Unitario Base. Usa sheets-listar-producto-unitario-base.config.js
 * (cargado por producto-unitario-base.html) para nombre de hoja, clave primaria, columnas y agrupación.
 */
(function () {
    var STORAGE_EDIT = "costosEditRecordProductoUnitarioBase";
    var STORAGE_FILTRO = "productoUnitarioBaseFiltroValor";
    var ACCIONES = window.PRODUCTO_UNITARIO_BASE_ACCIONES || {};
    var LISTAR_URL = (ACCIONES.listar && ACCIONES.listar.url) ? ACCIONES.listar.url : "producto-unitario-base.html";
    var CREAR_URL = (ACCIONES.crear && ACCIONES.crear.url) ? ACCIONES.crear.url : "crear-producto-unitario-base.html";
    var EDITAR_URL = (ACCIONES.editar && ACCIONES.editar.url) ? ACCIONES.editar.url : "editar-producto-unitario-base.html";
    var VER_URL = (ACCIONES.ver && ACCIONES.ver.url) ? ACCIONES.ver.url : "ver-producto-unitario-base.html";
    ...
    function renderList(container, sheetConfig, headers, rows, filterText, modoAgrupacionColumnas, valorFiltroColumna, indiceColumnaFiltro) {
        ...
        var clavePrimaria = sheetConfig.clavePrimaria || ["IDCosto-ProductoUnitario"];
        ...
        var nameColIdx = findColumnIndex(headers, ["nombreproducto", "nombre-producto", "nombre"]);
        ...
        columnas.forEach(function (col) {
            ...
            if (nameNorm === norm((headers[idColIdx] || ""))) return;
            if (nameNorm === norm((headers[nameColIdx] || ""))) return;
        ...
        var html = '<div class="costos-cards costos-cards-producto-unitario-base">';
        if (grouped && groupKeys && groupKeys.length > 0) {
            groupKeys.forEach(function (key) {
                ...
                groupRows.forEach(function (row) {
                    ...
                    html += "<div class=\"costos-card costos-card-producto-unitario-base\">";
        ...
        var countEl = document.getElementById("producto-unitario-base-count");
    ...
    function run() {
        var container = document.getElementById("datos-producto-unitario-base");
        var filterInput = document.getElementById("filter-producto-unitario-base");
        var btnNuevo = document.getElementById("btn-nuevo-producto-unitario-base");
        ...
        if (!loadConfig) {
            showMessage(container, "No se pudo cargar la configuración del módulo (producto-unitario-base-config.js).");
            return;
        }
        ...
        loadConfig()
            .then(function (sheetConfig) {
                ...
                var filtrarWrap = document.getElementById("producto-unitario-base-filtrar-wrap");
                var filtrarSelect = document.getElementById("filtrar-valores-producto-unitario-base");
                var agruparWrap = document.getElementById("producto-unitario-base-agrupar-wrap");
                var agruparSelect = document.getElementById("agrupar-producto-unitario-base");
                ...
                if (filtrarWrap && filtrarSelect && columnaFiltroValores) {
                    ...
                    var labelFiltrar = filtrarWrap.querySelector('label[for="filtrar-valores-producto-unitario-base"]');
                ...
                return fetch(url, { cache: "no-store" })
                    ...
                    .then(function (json) {
                        ...
                        function getModoActual() {
                            var sel = document.getElementById("agrupar-producto-unitario-base");
                        ...
                        function getValorFiltroActual() {
                            var sel = document.getElementById("filtrar-valores-producto-unitario-base");
